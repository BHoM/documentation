...
using BH.Adapter;
using BH.Engine.SoftwareName;

namespace BH.Adapter.SoftwareName
{
    public partial class SoftwareName_Adapter : BHoMAdapter
    {
        ...
        public SoftwareName_Adapter()
        {
            AdapterId = BH.Engine.SoftwareName.Convert.AdapterId;   //Set the "AdapterId" to "SoftwareName_id". Generally stored as a constant string in the convert class in the SoftwareName_Engine
